...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Шестизначный код подтверждения', example: '123456' }),
    ...
    (0, class_validator_1.Matches)(/^\d{6}$/, { message: 'Код подтверждения должен состоять из 6 цифр' }),
    __metadata("design:type", String)
], ConfirmPasswordResetDto.prototype, "code", void 0);
